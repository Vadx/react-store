import { Button, Divider, Card, Descriptions, Skeleton, Image } from "antd";
            ...
            <Descriptions.Item label="Gallery">
              <Card style={{ width: "100%", margin: 10 }}>
                {post.images && post.images.length ? (
                  post?.images.map((item: string) => (
                    <Card.Grid key={item} className="image-item">
                      <Image src={`${item}`} alt={post.title} loading="lazy" />
                    </Card.Grid>
                  ))
                ) : (
                  <Image
